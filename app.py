...
def add_points_to_map(m, data, provider='all', min_speed=0, max_speed=500):
    ...
    for _, row in filtered_data.iterrows():
        ...
        # Создаем всплывающее окно с улучшенным форматированием
        popup_html = f"""
        <div style="width: 250px; padding: 5px;">
            <h4 style="margin-top: 0; color: #0056A4; font-size: 16px;">{row['address']}</h4>
            <p style="margin: 5px 0;"><b>Скорость загрузки:</b> {current_speed:.1f} Мбит/с</p>
            <p style="margin: 5px 0;"><b>Координаты:</b> {row['latitude_speedtest']:.6f}, {row['longitude_speedtest']:.6f}</p>
            <p style="margin: 5px 0;"><b>Провайдеры:</b></p>
        ...
        # Добавляем маркер в соответствующую группу с улучшенной видимостью
